(function(window, angular, $) {
    ...
    if(flag==true){
        ...
        $(window.document).on('click','.main-navigation .table-files tr.item-list:has("td"), .item-list',function(e) {
            ...
            setTimeout("$('#context-menu').hide()",5000);
            e.preventDefault();
        });
         $(window.document).on('click', '#context-menu',function() {
            $('#context-menu').hide();
        });
    }
